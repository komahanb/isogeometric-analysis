...
\begin{itemize}
  \item FEM utilizes the approximate form of CAD geometry by discretizing them into a smaller sub-geometry called elements.  
  \item In IGA, CAD-based NURBS described geometries are directly employed in the analysis without making any geometrical approximations like in FEM.
  \item IGA reduces the burden of mesh regeneration and thus also minimizes the computational cost to a great extent.
  ...
  \item This technique can also be applied to specific problems which have been solved with FEM to attain improved solution.
\end{itemize}
\section{Framework}
...
FACTA UNIVERSITATIS, Vol. 11, ${N^o}$2, 2013.
